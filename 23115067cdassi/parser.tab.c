...
static const char *const yytname[] =
{
  ...
  "ASSIGN", "MUL", "ADD", "SEMICOLON", "$accept", "program", "stmt", YY_NULLPTR
};
...
#line 1071 "parser.tab.c"
  ...
  case 3: /* stmt: IDENTIFIER ASSIGN IDENTIFIER MUL IDENTIFIER ADD IDENTIFIER  */
#line 31 "parser.y"
                                                                 {
          char *result = malloc(100);
          snprintf(result, 100, "muladd %s, %s, %s, %s", (yyvsp[-6].str), (yyvsp[-4].str), (yyvsp[-2].str), (yyvsp[0].str));
          (yyval.str) = result;
      }
